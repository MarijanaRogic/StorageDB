...
namespace EFCoreAPI.Migrations
{
    ...
    [Migration("20230530144130_newColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreAPI.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("EFCoreAPI.Models.Storage", b =>
                {
                    b.Property<int>("StorageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreAPI.Models.StatesOfStorages", b =>
                {
                    b.HasOne("EFCoreAPI.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreAPI.Models.Storage", "Storage")
                        .WithMany()
